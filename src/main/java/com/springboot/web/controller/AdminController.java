...
import com.springboot.web.service.PurchaseItemService;
...
public class AdminController {
	...
	PurchaseItemService purchaseItemService;
	  ...
	  @RequestMapping(value = "/adminsearch",  method = RequestMethod.GET)
	    public String searchProduct(ModelMap map,  @RequestParam(value="id", required=true) String id,
	    		javax.servlet.http.HttpServletRequest request) 
	    {
		  // check if session is still alive
		  HttpSession session = request.getSession();
		  if (session.getAttribute("admin_id") == null) {
	        ...
	        return "admin/search-date"; 
	    }	
	  @RequestMapping(value = "/adminsearchdateaction",  method = RequestMethod.GET)
	    public String searchDate(ModelMap map,  @RequestParam(value="id", required=true) String id,
	    		javax.servlet.http.HttpServletRequest request,@RequestParam(value="date", required=true) Date date) {
					
		  List<Purchase> list = purchaseService.date(date);
		  ...
		  return "admin/dateproducts";
		  
	  }
	  
	  @RequestMapping(value = "/admincategory",  method = RequestMethod.GET)
	    public String searchCategory(ModelMap map,  @RequestParam(value="id", required=true) String id,
	    		javax.servlet.http.HttpServletRequest request) 
	    {
		  // check if session is still alive
	  ...
	  @RequestMapping(value = "/adminsearchcategoryaction", method = RequestMethod.GET)
	    public String sortCategory(ModelMap map, javax.servlet.http.HttpServletRequest request,
	    		 @RequestParam(value="category", required=true) String categoryId) 
	    {
		  
		  long categoryIdValue = Long.parseLong(categoryId);
		  List<Product> list = productService.sort(categoryIdValue);
		  
		  List<PurchaseItem> purchaseitems = new ArrayList<PurchaseItem>();
		  
		  for (Product product : list) {
			  purchaseitems = purchaseItemService.getCategoryById(product.getID());
		  ...
		  map.addAttribute("list", purchaseitems);


		  map.addAttribute("pageTitle", "ADMIN SORTED PRODUCTS");
		  
		  return "admin/categoryproducts";
	  ...
	  @RequestMapping(value = "/sortproduct",  method = RequestMethod.GET)
	    public String CatProduct(ModelMap map,  @RequestParam(value="id", required=true) String id,
	    		javax.servlet.http.HttpServletRequest request) 
	    {
		  // check if session is still alive
		  HttpSession session = request.getSession();
		  ...
		  map.addAttribute("catDropdown", dropDown);
		  map.addAttribute("pageTitle", "ADMIN EDIT PRODUCT");
	        return "admin/sort-product"; 
	    }	
	  @RequestMapping(value = "/adminsortproductaction", method = RequestMethod.GET)
	    public String sortProduct(ModelMap map, javax.servlet.http.HttpServletRequest request,
	    		 @RequestParam(value="category", required=true) String categoryId) 
	    {
		  long categoryIdValue = Long.parseLong(categoryId);
		  List<Product> list = productService.sort(categoryIdValue);
	  ...
	  @RequestMapping(value = "/adminsearchusers", method = RequestMethod.GET)
	    public String SearchUsers(ModelMap map, javax.servlet.http.HttpServletRequest request) 
	    {
		  return "admin/search";
	    }
	  @RequestMapping(value = "/adminresults",  method = RequestMethod.GET)
	    public String Users(ModelMap map,  @RequestParam(value="fname", required=true) String fname,@RequestParam(value="lname", required=true) String lname,
	    		javax.servlet.http.HttpServletRequest request) 
	    {
		  HttpSession session = request.getSession();
		  if (session.getAttribute("admin_id") == null) {
		  ...
		  List<User> list = userService.getUsers(fname,lname); 
		  map.addAttribute("list", list);
		  map.addAttribute("pageTitle", "ADMIN SEARCH MEMBERS");
